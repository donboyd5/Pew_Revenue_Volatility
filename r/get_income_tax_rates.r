...
# dfile <- "C:/Users/donbo/Documents/R_projects/Pew_Revenue_Volatility/raw_data/nber/maxrate.dat"
dfile <- r"(C:\Users\donbo\Documents\R_projects\Pew_Revenue_Volatility\raw_data\nber\maxrate.dat)"

download.file(url, here::here("raw_data", "nber", "maxrate.dat"))
...
cols <- fwf_cols(year = c(2, 5), 
                 ...
                 stname = c(94, 110))
ctypes <- "iiddc"
nber1 <- read_fwf(here::here("raw_data", "nber", "maxrate.dat"), 
               col_positions=cols,
               col_types = ctypes)

nber1
glimpse(nber1)
nber1 %>% filter(stname=="New York")
...
# download TPC file manually from https://www.taxpolicycenter.org/statistics/state-individual-income-tax-rates
# as the url they give does not seem to work
fpath <- here::here("raw_data", "tpc", "state_income_tax_rates_0.xlsx")
