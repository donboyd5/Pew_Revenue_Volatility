...
However, the actual figure numbering in that document does not match the numbering below because I forgot to force an update to that numbering before I submitted the document. If you force renumbering in the Word doc (ctrl-A, then F9), its new numbering will match what you see below.
