...
# bdata bggtools bmaps btools
# BEAData BLSdata qtax
devtools::build(pkg = file.path(pkgsource_dir, "btools"),  
                path = pkgdir,
                binary = FALSE,
                vignettes = FALSE,
                manual = FALSE,
...
# bdata - selected data - state population, etc.
#         data(package="bdata") # shows what's in it
# bggtools - tools for ggplot2, such as recession bands
# bmaps - maps of continental U.S. + DC (states49), plus 50 states + DC (states51)
# btools - various convenience functions

# BEAData
# BLSdata
# qtax

# after building the packages, install them; be SURE that the version number for
# each package matches the latest version in the renv/local folder

# renv::install(file.path(pkgdir, "bdata_0.9.tar.gz"))
# renv::install(file.path(pkgdir, "bggtools_0.0.9200.tar.gz"))
# renv::install(file.path(pkgdir, "bmaps_0.1.0.tar.gz"))
# renv::install(file.path(pkgdir, "btools_0.9.4.tar.gz"))
