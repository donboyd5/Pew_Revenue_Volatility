...
## Two kinds of revenue volatility
...
p1 <- dfl %>%
  ...
  nolegend_title
p1
ggsave(filename = here::here("results", "trend_cycle_random.png"), plot = p1, width=8, height=6)
...
# 
# dfl %>%
#   ggplot(aes(time, pdiff, colour=name)) +
#   geom_line()
...
```{r cggdp_plot, fig.height=6, fig.width=6}
